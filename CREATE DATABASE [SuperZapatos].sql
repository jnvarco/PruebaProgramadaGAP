...
/****** Object:  Database [SuperZapatos]    Script Date: 23/01/2017 08:29:44:p.m. ******/
CREATE DATABASE [SuperZapatos]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'SuperZapatos', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL12.MSSQLSERVER\MSSQL\DATA\SuperZapatos.mdf' , SIZE = 5120KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'SuperZapatos_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL12.MSSQLSERVER\MSSQL\DATA\SuperZapatos_log.ldf' , SIZE = 1024KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
